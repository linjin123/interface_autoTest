...
class GetToken_H5:
    ...
    def get_token_H5(url,send_data):
        ...
        token_data["req_seq_no"] = "%s" % send_data["req_seq_no"]
        ...
        token_data["session_id"] ="%s" %send_data["session_id"]
...
if __name__ == '__main__':
    gettoken = GetToken_H5()
    gettoken.get_token_H5()
